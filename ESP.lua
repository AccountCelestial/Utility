...
function EspObject:Construct()
    ...
    self.TaskLib:AddTask(self.renderConnection);
end
...
function ChamObject:Construct()
    ...
    self.TaskLib:AddTask(self.highlight);
    
    self.updateConnection = runService.Heartbeat:Connect(function()
        self:Update();
    end);
    
    self.TaskLib:AddTask(self.updateConnection);
end
...
function InstanceObject.new(instance, options)
    ...
    self.TaskLib:AddTask(self.text);
    ...
    self.TaskLib:AddTask(self.removedConnection);
...
function InstanceObject:Destruct()
    ...
    if self.TaskLib then self.TaskLib:Cleanup(); end;
    clear(self);
end;
...
function EspInterface.Load()
    ...
    EspInterface.TaskLib:AddTask(EspInterface.playerAdded);
    EspInterface.TaskLib:AddTask(EspInterface.playerRemoving);
